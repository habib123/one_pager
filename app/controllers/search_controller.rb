  ...
  def search_result
    ...
    result_array = []
      ...
      if !search_text_array.empty?
        ...
        type_search_result_by_mig_status = OnePager.where(type: search_criteria).where("mig_status like ?", "%#{search_text}%")
        type_search_result_by_pat_num = OnePager.where(type: search_criteria).where("single_patent_num like ?", "%#{search_text}%")
        ...
        result_array = result_array + type_search_result_by_pat_num
        result_array = result_array + type_search_result_by_mig_status
